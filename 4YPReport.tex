...
\begin{document}
	...
	\begin{abstract}
		...
		The purpose of this project is to put together many of the modern algorithms in Perception to evaluate how an integrated system perform in real-life data. The full system presented here consists of state-of-the-art algorithms in the fields aforementioned. The system is put to test using three different real-world datasets collected using the MultiSense SL sensor.
