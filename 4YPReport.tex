...
\begin{figure}[!b]
	\centering
		\begin{tabular}{cc}
			\subfloat[$S=1; E=2$]{\includegraphics[width = 0.5\linewidth]{Clouds/21045}} &
			\subfloat[$S=2; E=3$]{\includegraphics[width = 0.5\linewidth]{Clouds/32045}}\\
			\subfloat[$S=1; E=4$]{\includegraphics[width = 0.5\linewidth]{Clouds/41045}} &
			\subfloat[$S=3; E=5$]{\includegraphics[width = 0.5\linewidth]{Clouds/53045}}
		\end{tabular}
...
\begin{figure}
	\ContinuedFloat
		\begin{tabular}{cc}
			\subfloat[(c) and (d) superimposed. (c) in white and (d) in blue]{\includegraphics[width = 0.5\linewidth]{Clouds/5Wand4B}} &
			\subfloat[No Loop Closure]{\includegraphics[width = 0.5\linewidth]{Clouds/NoLoopClosure}}
		\end{tabular}
