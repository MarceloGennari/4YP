...
Stereo Cameras are passive sensors which use the difference in position of two cameras to convey depth. This is analogous to how most mammals see and one of the reasons why humans can perceive depth (humans also use monocular cues for that end \cite{goldstein2016sensation}).
...
Some of the most limiting factors about Stereo Camera is that they need to solve the correspondence problem to get depth information, which depends on the extraction of features. This is computationally inefficient since it requires algorithmically complex systems to extract features (more about that in Section \ref{subs:SVO}). It also means that it can only solve the correspondence problem in situations where there is texture in the scene (plenty of edges and corners for example). Consider a white wall for instance. Since there is not much features to be extracted, the correspondence would be unreliable and render a poor estimation of depth for the stereo vision. This limitation is not faced by Active Sensors for example.

	\subsubsection{Structured Light Sensors}

Structured Light Sensor became particularly popular since the release of the Kinect Sensor by Microsoft (see Figure \ref{fig:KinectSensor}). It works by projecting a pattern of light in the infra-red, sensing the reflected light and getting a disparity map. It is analogous to a stereo camera where one of the cameras is replaced by a light emitter. The advantages of using that method instead of pure stereo vision for depth information is that ...
...
\begin{figure}[!b]
	\centering
		\begin{tabular}{cc}
			\subcaptionbox{$S=1; E=2$}{\includegraphics[width = 0.5\linewidth]{Clouds/21045}} &
			\subcaptionbox{$S=2; E=3$}{\includegraphics[width = 0.5\linewidth]{Clouds/32045}}\\
			\subcaptionbox{$S=1; E=4$}{\includegraphics[width = 0.5\linewidth]{Clouds/41045}} &
			\subcaptionbox{$S=3; E=5$}{\includegraphics[width = 0.5\linewidth]{Clouds/53045}}
		\end{tabular}
\end{figure}
\begin{figure}
	\ContinuedFloat
		\begin{tabular}{cc}
			\subcaptionbox{(c) and (d) superimposed. (c) in white and (d) in blue}{\includegraphics[width = 0.5\linewidth]{Clouds/5Wand4B}} &
			\subcaptionbox{No Loop Closure}{\includegraphics[width = 0.5\linewidth]{Clouds/NoLoopClosure}}
		\end{tabular}
	\caption{Results of applying different values of the S, E and O parameters for the same dataset. It can be seen that they give noticeably different maps, even though they are all better than the no loop closure map. This is shown by looking at the top right corner and the bottom right corner of the images, which shows that the no loop closure is the one that the walls are noticeably not superimposed. }
...
As explained in Section \ref{pipeline}, the result of the Graph Optimization is then input to BORG-CUBES. Since this algorithm was built to reconstruct cities with an eye at autonomous driving, it expects a pretty dense representation of the LiDAR point clouds. Unfortunately, this is not the case for mobile robots operating indoors with a single LiDAR sensor.
...
\begin{figure}[h]
	...
	\begin{tabular}{cccc}
	\subcaptionbox{$\lambda \to \infty$}{\includegraphics[width = 0.5\linewidth]{Regularizer/Unreg}} &
	\subcaptionbox{$\lambda = 1$}{\includegraphics[width = 0.5\linewidth]{Regularizer/1Lambda}}\\
	\subcaptionbox{$\lambda = 0.5$}{\includegraphics[width = 0.5\linewidth]{Regularizer/05Lambda}} &
	\subcaptionbox{$\lambda = 0.1$}{\includegraphics[width = 0.5\linewidth]{Regularizer/01Lambda}}
\end{tabular} 
...
\begin{figure}[h]
	...
	\begin{tabular}{cccc}
		\subcaptionbox{Voxel edge = $10cm$}{\includegraphics[width = 0.5\linewidth]{VoxelEdge/Voxel01}} &
		\subcaptionbox{Voxel edge = $30cm$}{\includegraphics[width = 0.5\linewidth]{VoxelEdge/Voxel03}}\\
		\subcaptionbox{Voxel edge = $50cm$}{\includegraphics[width = 0.5\linewidth]{VoxelEdge/Voxel05}} &
		\subcaptionbox{Voxel edge = $1m$}{\includegraphics[width = 0.5\linewidth]{VoxelEdge/Voxel1}}
	\end{tabular} 
...
\subcaptionbox{}{\includegraphics[width = 0.3\linewidth]{Maps1/PTCL1}} &
\subcaptionbox{}{\includegraphics[width = 0.3\linewidth]{Maps1/PTCL2}} &
\subcaptionbox{}{\includegraphics[width = 0.3\linewidth]{Maps1/PTCL3}} \\
\subcaptionbox{}{\includegraphics[width = 0.3\linewidth]{Maps1/Rec1}} &
\subcaptionbox{}{\includegraphics[width = 0.3\linewidth]{Maps1/Rec2}} &
\subcaptionbox{}{\includegraphics[width = 0.3\linewidth]{Maps1/Rec3}} \\
\subcaptionbox{}{\includegraphics[width = 0.3\linewidth]{Maps1/Rec1N}} &
\subcaptionbox{}{\includegraphics[width = 0.3\linewidth]{Maps1/Rec2N}} &
\subcaptionbox{}{\includegraphics[width = 0.3\linewidth]{Maps1/Rec3N}} \\
\subcaptionbox{}{\includegraphics[width = 0.3\linewidth]{Maps1/RegRec1}} &
\subcaptionbox{}{\includegraphics[width = 0.3\linewidth]{Maps1/RegRec2}} &
\subcaptionbox{}{\includegraphics[width = 0.3\linewidth]{Maps1/RegRec3}}\\
\subcaptionbox{}{\includegraphics[width = 0.3\linewidth]{Maps1/RegRec1N}} &
\subcaptionbox{}{\includegraphics[width = 0.3\linewidth]{Maps1/RegRec2N}} &
\subcaptionbox{}{\includegraphics[width = 0.3\linewidth]{Maps1/RegRec3N}}
\end{tabular}
\vspace{10pt}
...
\captionsetup[subfigure]{labelformat=empty}
\begin{tabular}{ccc}
\subcaptionbox{}{\includegraphics[width = 0.3\linewidth]{Maps2/PTCL1}} &
\subcaptionbox{}{\includegraphics[width = 0.3\linewidth]{Maps2/PTCL2}} &
